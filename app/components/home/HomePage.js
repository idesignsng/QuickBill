        ...
        return(
            <div className="home">
                <div className="home__banner home__banner--bg">
                    ...
                    <h2>Free and Simple <span>invoicing</span> for freelancers, students and businesses.</h2>
                ...
                <div className="home__banner home__banner--footer">
                    <h4>Startt this project on Github</h4>
                    ...
                    <a href="https://awamart.com.ng/register/" className="solid-btn"><i className="fa fa-envelope" aria-hidden="true"></i>List your Business!</a>
                </div>
            </div>
        );
    }
